 ...
 * @author ribadas
 */
public class PLSQL extends TeamRobot {

    public static String FICHERO_REGLAS = "grupo4/reglas/PLSQL.drl";
    public static String CONSULTA_ACCIONES = "plsqlca";
    ...
    private void crearBaseConocimiento() {
        String ficheroReglas = System.getProperty("robot.reglas", PLSQL.FICHERO_REGLAS);

        DEBUG.mensaje("crear base de conocimientos");
        kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        
        DEBUG.mensaje("cargar reglas desde "+ficheroReglas);
        kbuilder.add(ResourceFactory.newClassPathResource(ficheroReglas, PLSQL.class), ResourceType.DRL);
    ...
    private Vector<Accion> recuperarAcciones() {
        ...
        for (QueryResultsRow resultado : ksession.getQueryResults(PLSQL.CONSULTA_ACCIONES)) {
