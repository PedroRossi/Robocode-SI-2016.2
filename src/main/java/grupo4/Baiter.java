...
public class Baiter extends TeamRobot {

    public static String FICHERO_REGLAS = "grupo4/reglas/baiter.drl";
    public static String CONSULTA_ACCIONES = "baiterca";
    ...
    public void run() {
        ...
        while (true) {
            ...
            DEBUG.mensaje("Regras: "+ksession.fireAllRules());
    ...
    private void crearBaseConocimiento() {
        String ficheroReglas = System.getProperty("robot.reglas", Robocop.FICHERO_REGLAS);

        DEBUG.mensaje("crear base de conocimientos");
        kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();

        DEBUG.mensaje("cargar reglas desde "+ficheroReglas);
        kbuilder.add(ResourceFactory.newClassPathResource(ficheroReglas, Robocop.class), ResourceType.DRL);
    ...
    private Vector<Accion> recuperarAcciones() {
        ...
        for (QueryResultsRow resultado : ksession.getQueryResults(Robocop.CONSULTA_ACCIONES)) {
